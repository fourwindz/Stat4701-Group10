...
ggplot(duration, aes(year, days))+geom_bar(stat = "identity") + labs(title="Interannual Evolution of Flood Duration (since 1985)", x="Calendar Year", y="Avg.Duration in Days") + theme(legend.position="False")
```
...
ggplot(test, aes(x=year, y=pct)) + geom_bar(stat='identity') + facet_grid(level ~.) + labs(title="Percentage of floods with different severity class (since 1985)",x="Calendar Year",y="Percentage of Total, %") + scale_x_continuous(breaks=seq(min(sev$year), max(sev$year),by=1)) + theme(legend.position="False")
```
...
ggplot(dead.year, aes(year, dead))+geom_bar(stat = "identity") + labs(title="Average number of people killed by floods (since 1985)", x="Calendar Year", y="Avg.Number of People Killed") + theme(legend.position="False")
```
...
ggplot(displaced.year, aes(year, displaced))+geom_bar(stat = "identity") + labs(title="Average number of people displaced because of floods (since 1985)", x="Calendar Year", y="Avg.Number of People Displaced") + theme(legend.position="False")
```
